...
export function GoogleAuthButton() {
    ...
    return (
        <Button
            variant="outline"
            size="lg"
            className="w-full flex items-center justify-center gap-3 border-[rgba(0,0,66,0.12)] hover:bg-[rgba(0,0,66,0.02)] transition-all duration-200"
        ...
        >
            ...
            <span className="font-medium text-[#000042]">Continue with Google</span>
        </Button>
    );
}
